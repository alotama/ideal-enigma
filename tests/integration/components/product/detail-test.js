...
module('Integration | Component | product-card', function(hooks) {
  ...
  test('it renders', async function(assert) {
    ...
    assert.dom('[data-test-name]').hasText('Strawberries', 'El nombre del producto se renderiza correctamente');
    
    assert.dom('[data-test-price]').hasText('£5.00', 'El precio del producto se renderiza correctamente');
    ...
    assert.dom('[data-test="count-value"]').hasText('2', 'El conteo se decrementa después de hacer clic en "Remove from Cart"');
  });
});
